/* ------------------------------------------------------------------
* node-enocean-utils - node-enocean-utils-eep-data-A5-06-02.js
*
* Copyright (c) 2016 - 2018, Futomi Hatano, All rights reserved.
* Released under the MIT license
* Date: 2018-06-01
*
* EEP:A5-06-02 (EEP 2.6.5 specification P37)
...
EnoceanUtilsEepDataParser.prototype.parse = function(dd_buf) {
	...
	// Supply voltage
	let svc = db3;
	let svc_result = svc * 5.1 / 255;
	let svc_desc = svc_result + ' V';
	// Illumination 2
	let ill2 = db2;
	let ill2_result = ill2 * 510 / 255;
	let ill2_desc = ill2_result + ' lx';
	// Illumination 1
	let ill1 = db1;
	let ill1_result = ill1 * 1020 / 255;
